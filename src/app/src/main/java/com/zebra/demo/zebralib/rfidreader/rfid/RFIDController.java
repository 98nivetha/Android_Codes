...
import com.zebra.demo.zebralib.rfidreader.reader_connection.ReaderBTDevice;
...
public class RFIDController {
    ...
    public static int usbBatchMode;
    public static int scanBatchMode;
    public static IEvents.BatteryData BatteryData = null;
    ...
    public static boolean sgtinMode = false;
    ...
    public void inventoryWithTamperfind(String memoryBankID, RfidListeners rfidListeners) {
        inventoryController.inventoryWithTamperfind(memoryBankID, rfidListeners);
    }
    ...
    public void accessOperationLock(String tagId, String accessRwPassword, LOCK_DATA_FIELD lockDataField, LOCK_PRIVILEGE lockPrivilege, boolean ALL_Memory_Bank, RfidListeners rfidListeners) {
        accessOperationController.accessOperationLock(tagId, accessRwPassword, lockDataField, lockPrivilege,ALL_Memory_Bank, rfidListeners );
    }
    ...
    public static boolean isPrefilterEnabled() {
        ...
        if (mConnectedReader == null || mConnectedReader.Actions == null || mConnectedReader.Actions.PreFilters.length() == 0)
            return false;
        try {
    ...
    public static void startTimer() {
        if (scheduler == null) {
            ...
            taskHandle = scheduler.scheduleAtFixedRate(task, 0, 30, SECONDS);
        }
    }
