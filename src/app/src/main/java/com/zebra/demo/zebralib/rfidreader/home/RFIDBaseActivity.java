package com.zebra.demo.zebralib.rfidreader.home;
...
import com.zebra.demo.zebralib.ManageDeviceActivity;
...
import com.zebra.demo.zebralib.rfidreader.access_operations.AccessOperationsLockFragment;
...
import com.zebra.demo.zebralib.rfidreader.common.ResponseHandlerInterfaces.BatteryNotificationHandler;
import com.zebra.demo.zebralib.rfidreader.common.ResponseHandlerInterfaces.ReaderDeviceFoundHandler;
import com.zebra.demo.zebralib.rfidreader.common.ResponseHandlerInterfaces.TriggerEventHandler;
import com.zebra.demo.zebralib.rfidreader.common.asciitohex;
...
import com.zebra.demo.zebralib.rfidreader.locate_tag.RangeGraph;
import com.zebra.demo.zebralib.rfidreader.locate_tag.multitag_locate.MultiTagLocateFragment;
import com.zebra.demo.zebralib.rfidreader.locate_tag.multitag_locate.MultiTagLocateResponseHandlerTask;
...
import com.zebra.demo.zebralib.rfidreader.reader_connection.BluetoothHandler;
...
import static com.zebra.demo.zebralib.DeviceDiscoverActivity.isBluetoothEnabled;
...
import static com.zebra.demo.zebralib.application.Application.MultiTagInventoryMultiSelect;
import static com.zebra.demo.zebralib.application.Application.RFIDBAseEventHandler;
...
import static com.zebra.demo.zebralib.application.Application.iBrandIDLen;
import static com.zebra.demo.zebralib.application.Application.inventoryList;
import static com.zebra.demo.zebralib.application.Application.isFirmwareUpdateInProgress;
import static com.zebra.demo.zebralib.application.Application.mIsMultiTagLocatingRunning;
...
import static com.zebra.demo.zebralib.application.Application.strBrandID;
...
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.AUTO_DETECT_READERS;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.AUTO_RECONNECT_READERS;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.BatteryData;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.EXPORT_DATA;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.LAST_CONNECTED_READER;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.NON_MATCHING;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.NOTIFY_BATTERY_STATUS;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.NOTIFY_READER_AVAILABLE;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.NOTIFY_READER_CONNECTION;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.SHOW_CSV_TAG_NAMES;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.TAG;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.TagProximityPercent;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.asciiMode;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.autoConnectDeviceTask;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.bFound;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.beeperVolume;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.brandidcheckenabled;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.channelIndex;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.clearInventoryData;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.currentFragment;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.dynamicPowerSettings;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.inventoryMode;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.isAccessCriteriaRead;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.isBatchModeInventoryRunning;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.isGettingTags;
...
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.is_connection_requested;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.is_disconnection_requested;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.ledState;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.mConnectedDevice;
...
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.pc;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.phase;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.readers;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.readersList;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.regionNotSet;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.reset;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.rssi;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.settings_startTrigger;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.settings_stopTrigger;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.sgtinMode;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.tagListMatchAutoStop;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.tagListMatchNotice;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.toneGenerator;
import static com.zebra.demo.zebralib.rfidreader.settings.AdvancedOptionsContent.DPO_ITEM_INDEX;
...
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.PROFILES_TAB;
...
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.RFID_ABOUT_TAB;
    ...
    public synchronized void inventoryStartOrStop() {
        ...
        if (mConnectedReader != null && mConnectedReader.isConnected()) {
            if (!mIsInventoryRunning) {
                ...
                if (fragment != null && fragment instanceof BarcodeRFIDScanBaseFragment) {
                    memoryBankId = -1;
                    ((BarcodeRFIDScanBaseFragment) fragment).resetTagsInfo();
                    if (TAG_LIST_MATCH_MODE) {
                        if (missedTags > 9999) {
                            TextView uniqueTags = (TextView) mActivity.findViewById(R.id.uniqueTagContent);
                            //orignal size is 60sp - reduced size 45sp
                    ...
                    ((BarcodeRFIDScanBaseFragment) fragment).updateTexts();
                }
                ...
                try {
                    RFIDController.getInstance().stopInventory(new RfidListeners() {
                        ...
                        public void onSuccess(Object object) {
                            ...
                            else if (fragment instanceof BarcodeRFIDScanBaseFragment)
                                ((BarcodeRFIDScanBaseFragment) fragment).resetInventoryDetail();
                        }
    ...
    * On factory reset clean up
    ...
    private void notificationFromGenericReader(RfidStatusEvents rfidStatusEvents) {
        ...
        if (rfidStatusEvents.StatusEventData.getStatusEventType() == STATUS_EVENT_TYPE.DISCONNECTION_EVENT) {
            ...
            if (mIsInventoryRunning  || Inventorytimer.getInstance().isTimerRunning() == true) {
                ...
                if (EXPORT_DATA) {
                    if (TAG_LIST_MATCH_MODE) {
                        ...
                        } else if (tagsReadInventory != null && !tagsReadInventory.isEmpty() && fragment instanceof BarcodeRFIDScanBaseFragment && UNIQUE_TAGS != 0) {
                            currentFragment = "BarcodeRFIDScanBaseFragment";
                            mActivity.runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    createFileInterface.createFile1(uri);
            ...
            if (fragment instanceof BarcodeRFIDScanBaseFragment)
                mActivity.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        ((BarcodeRFIDScanBaseFragment) fragment).updateInventoryDetails();
                    }
                });
