...
import com.zebra.demo.zebralib.rfidreader.home.RFIDEventHandler;
import com.zebra.demo.zebralib.rfidreader.notifications.NotificationUtil;
import com.zebra.demo.zebralib.rfidreader.reader_connection.InitReadersListFragment;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.nav_battery_statics:
                ...
                detailsIntent.putExtra(com.zebra.demo.zebralib.rfidreader.common.Constants.SETTING_ITEM_ID, Integer.parseInt(SettingsContent.ITEMS.get(3).id));
...
//    }
    ...
    public void sendNotification(String action, String data) {
        if (action.equalsIgnoreCase(com.zebra.demo.zebralib.rfidreader.common.Constants.ACTION_READER_BATTERY_CRITICAL) || action.equalsIgnoreCase(com.zebra.demo.zebralib.rfidreader.common.Constants.ACTION_READER_BATTERY_LOW)) {
