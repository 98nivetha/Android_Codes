...
import static com.zebra.demo.zebralib.scanner.helpers.Constants.*;
...
public class ScaleActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener, ScannerAppEngine.IScannerAppEngineDevConnectionsDelegate {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_pair_device) {
            ...
            finish();
            navigateActivity = new Intent(ScaleActivity.this, ScannerHomeActivity.class);
    ...
    public boolean scannerHasDisconnected(int scannerID) {
        ...
        this.finish();
        Application.currentScannerId = Application.SCANNER_ID_NONE;
        Intent intent = new Intent(ScaleActivity.this, ScannerHomeActivity.class);
        startActivity(intent);
        return true;
    }
