...
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.antennaRfConfig;
...
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.singulationControl;
...
public class ProfileContent {
    ...
    public static void UpdateProfilesForRegulatory() {
        ...
        ProfilesItem FastReadProfile = ProfileContent.ITEMS.get(0);
        ProfilesItem DenseModeProfile = ProfileContent.ITEMS.get(2);
        ProfilesItem CycleCountProfile = ProfileContent.ITEMS.get(1);
        ProfilesItem OptBatteryProfile = ProfileContent.ITEMS.get(3);
        ProfilesItem BalancePerformProfile = ProfileContent.ITEMS.get(4);
        ProfilesItem UserProfile = ProfileContent.ITEMS.get(5);
        ...
        switch (readersku) {
            case "US":
            case "WR":
                LinkProfileUtil linkProfileUtil = LinkProfileUtil.getInstance();
                ArrayList<String> simpleProfiles = linkProfileUtil.getSimpleProfiles();
                if(!simpleProfiles.contains("FM0 640K")){
