...
import com.zebra.demo.zebralib.scanner.helpers.SSASymbologyType;
...
import static com.zebra.demo.zebralib.scanner.activities.BatteryStatistics.attrs;
...
//                    getSlowetDecodeImageProgressDialog.show();
    ...
    private boolean saveToInternalStorage(Bitmap finalBitmap) {
        ...
        if (finalBitmap != null && Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q)
        {
...
//                    });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_pair_device) {
            ...
            finish();
            intent = new Intent(ScanSpeedAnalyticsActivity.this, ScannerHomeActivity.class);
    ...
    public boolean scannerHasDisconnected(int scannerID) {
        ...
        this.finish();
        Application.currentScannerId =Application.SCANNER_ID_NONE;
        Intent intent = new Intent(ScanSpeedAnalyticsActivity.this, ScannerHomeActivity.class);
        startActivity(intent);
        return true;
    }
