...
public class AssetSearchViewModel extends ViewModel {
    ...
    //Get All List init
    public MutableLiveData<FilterAssetRFIDMappingData> metaDetailMutableLiveData = new MutableLiveData<>();
    ...
    //Tag Search Object
    public  DSubPartDetails selectedDSubPartDetails;
    ...
    public void fetchMetaDetails(ApiResponseListener apiResponseListener) {
        ...
        tagMappingRepository.getAllAssetRFIDMapping(0, new ResponseListener<FilterAssetRFIDMappingResponse>() {
            @Override
            public void onDataReceived(FilterAssetRFIDMappingResponse filterAssetRFIDMappingResponse) {
                if (filterAssetRFIDMappingResponse != null && filterAssetRFIDMappingResponse.Data != null) {

                    metaDetailMutableLiveData.setValue(filterAssetRFIDMappingResponse.Data);

                    FilterAssetRFIDMappingData filterAssetRFIDMappingData = filterAssetRFIDMappingResponse.Data;

                    //Company
                    if (filterAssetRFIDMappingData.D_CompanyDetails != null) {
                        companyDetailsDDListLiveData.setValue(filterAssetRFIDMappingData.D_CompanyDetails);
                    }

                    //Building
                    if (filterAssetRFIDMappingData.D_CompanyDetails != null) {
                        buildingDetailsDDListLiveData.setValue(filterAssetRFIDMappingData.D_BuildingDetails);
                    }

                    //Floor
                    if (filterAssetRFIDMappingData.D_CompanyDetails != null) {
                        floorDetailsDDListLiveData.setValue(filterAssetRFIDMappingData.D_FloorDetails);
                    }

                    //Location
                    if (filterAssetRFIDMappingData.D_CompanyDetails != null) {
                        locationDetailsDDListLiveData.setValue(filterAssetRFIDMappingData.D_LocationDetails);
                    }

                    //Asset Class
                    if (filterAssetRFIDMappingData.D_CompanyDetails != null) {
                        assetClassDetailsDDListLiveData.setValue(filterAssetRFIDMappingData.D_AssetclassDetails);
                    }

                    //Asset
                    if (filterAssetRFIDMappingData.D_CompanyDetails != null) {
                        assetDetailsDDListLiveData.setValue(filterAssetRFIDMappingData.D_AssetResgiterDetails);
                    }

                    //Sub Asset
                    if (filterAssetRFIDMappingData.D_CompanyDetails != null) {
                        subAssetDetailsDDListLiveData.setValue(filterAssetRFIDMappingData.D_AssetSubcodeDetails);
                    }

                    //Sub Asset Part
                    if (filterAssetRFIDMappingData.D_CompanyDetails != null) {
                        subAssetPartDetailsDDListLiveData.setValue(filterAssetRFIDMappingData.D_AssetSubcodepartsDetails);
                    }
