...
public class Constants {
    ...
    public static final String ACTION_READER_SET_REGION = "com.rfidreader.set.region";
    ...
    public static final String SGTIN_MODE = "SGTIN_MODE";
    public static final String LAST_READER = "LAST_CONNECTED_READER";
    public static final String KEYLAYOUT = "KEYLAYOUT";
    ...
    public static final String SETTING_ON_FACTORY = "settingOnFactory";
    ...
    public static boolean showSerialNo = false;
