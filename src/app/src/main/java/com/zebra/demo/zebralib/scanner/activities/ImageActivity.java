...
public class ImageActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener, ScannerAppEngine.IScannerAppEngineDevConnectionsDelegate, ScannerAppEngine.IScannerAppEngineDevEventsDelegate {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_pair_device) {
            ...
            finish();
            intent = new Intent(ImageActivity.this, ScannerHomeActivity.class);
    ...
    public boolean scannerHasDisconnected(int scannerID) {
        ...
        this.finish();
        Application.currentScannerId = Application.SCANNER_ID_NONE;
        Intent intent = new Intent(ImageActivity.this, ScannerHomeActivity.class);
        startActivity(intent);
        return true;
    }
    ...
    public void saveImage(View view) {
        ...
        if (retrievedDecodeImage != null && Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
        ...
        } else if (retrievedDecodeImage != null && Build.VERSION.SDK_INT < Build.VERSION_CODES.Q) {
            try {
                int os = Build.VERSION.SDK_INT;
    ...
    private void saveImage() {
        ...
        // TODO using media filesystem API
    }
