...
//        addItem(new SettingItem(R.id.wifi_power + "", "WiFi ",/*"Status",*/R.drawable.settings_wifi_icon));// icon need to be replaced.
        addItem(new SettingItem(R.id.charge_terminal + "", "Charge Terminal ",/*"Status",*/R.drawable.settings_ct_icon));// icon need to be replaced.
