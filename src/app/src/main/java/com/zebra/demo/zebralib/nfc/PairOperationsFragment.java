package com.zebra.demo.zebralib.nfc;
...
import com.zebra.demo.zebralib.rfidreader.reader_connection.ScanBarcodeAndPairFragment;
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        menu.findItem( R.id.action_readerlist).setOnMenuItemClickListener( new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if(className.equals("com.zebra.demo.zebralib.DeviceDiscoverActivity"))
                {
                    Fragment fragment = InitReadersListFragment.getInstance();
                    ((DeviceDiscoverActivity) getActivity()).switchToFragment(fragment);
                }else if(className.equals("com.zebra.demo.zebralib.ActiveDeviceActivity"))
