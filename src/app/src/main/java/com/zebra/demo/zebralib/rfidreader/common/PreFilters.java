...
public class PreFilters {
    ...
    /**
     * Constructor of the {@link com.zebra.demo.zebralib.rfidreader.common.PreFilters}
     *
     * @param tag             tag id
    ...
    public PreFilters(com.zebra.rfid.api3.PreFilters.PreFilter preFilterData) {
        ...
        int mBitCount = preFilterData.getTagPatternBitCount();
        this.setTag(tag);
        this.setMemoryBank(memBank);
        this.setAction(action);
        this.setTarget(target);
        this.setBitCount(mBitCount);
