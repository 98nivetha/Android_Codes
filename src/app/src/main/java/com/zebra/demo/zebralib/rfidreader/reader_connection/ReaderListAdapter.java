...
public class ReaderListAdapter extends ArrayAdapter<ReaderDevice> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView imgvw = (ImageView) convertView.findViewById(R.id.imgvw_reader);
        if(rfidReader.getTransport()=="BLUETOOTH"){
            imgvw.setImageResource(R.drawable.ic_action_bluetooth_connected);
        }
        else if(rfidReader.getTransport()=="SERVICE_SERIAL"){
            imgvw.setImageResource(R.drawable.ic_serial_connection);
        }
        else{
            imgvw.setImageResource(R.drawable.ic_action_usb);
        }
