package com.zebra.demo.zebralib.scanner.receivers;
...
import com.zebra.demo.zebralib.scanner.activities.ScannerHomeActivity;
import com.zebra.demo.zebralib.scanner.activities.ScannersActivity;
...
public class NotificationsReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(notificationType == Constants.SESSION_TERMINATED){
            resultIntent = new Intent(context, ScannerHomeActivity.class);
        }
