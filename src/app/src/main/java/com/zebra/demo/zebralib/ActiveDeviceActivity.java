...
import com.zebra.demo.view.fragment.AssetViewFragment;
...
import com.zebra.demo.zebralib.rfidreader.common.Inventorytimer;
import com.zebra.demo.zebralib.rfidreader.common.MatchModeFileLoader;
import com.zebra.demo.zebralib.rfidreader.common.ResponseHandlerInterfaces;
import com.zebra.demo.zebralib.rfidreader.data_export.DataExportTask;
...
import com.zebra.demo.zebralib.rfidreader.manager.FactoryResetFragment;
import com.zebra.demo.zebralib.rfidreader.manager.ManagerFragment;
import com.zebra.demo.zebralib.rfidreader.manager.ScanHomeSettingsFragment;
import com.zebra.demo.zebralib.rfidreader.notifications.NotificationUtil;
import com.zebra.demo.zebralib.rfidreader.rapidread.RapidReadFragment;
import com.zebra.demo.zebralib.rfidreader.reader_connection.RFIDReadersListFragment;
import com.zebra.demo.zebralib.rfidreader.reader_connection.ScanAndPairFragment;
import com.zebra.demo.zebralib.rfidreader.rfid.ConnectionController;
import com.zebra.demo.zebralib.rfidreader.rfid.RFIDController;
import com.zebra.demo.zebralib.rfidreader.rfid.RfidListeners;
import com.zebra.demo.zebralib.rfidreader.settings.AdvancedOptionItemFragment;
import com.zebra.demo.zebralib.rfidreader.settings.AdvancedOptionsContent;
import com.zebra.demo.zebralib.rfidreader.settings.AntennaSettingsFragment;
import com.zebra.demo.zebralib.rfidreader.settings.ApplicationSettingsFragment;
import com.zebra.demo.zebralib.rfidreader.settings.BackPressedFragment;
import com.zebra.demo.zebralib.rfidreader.settings.BatteryFragment;
import com.zebra.demo.zebralib.rfidreader.settings.BatteryStatsFragment;
import com.zebra.demo.zebralib.rfidreader.settings.BeeperFragment;
import com.zebra.demo.zebralib.rfidreader.settings.ChargeTerminalFragment;
import com.zebra.demo.zebralib.rfidreader.settings.DPOSettingsFragment;
import com.zebra.demo.zebralib.rfidreader.settings.ISettingsUtil;
import com.zebra.demo.zebralib.rfidreader.settings.KeyRemapFragment;
import com.zebra.demo.zebralib.rfidreader.settings.LedFragment;
import com.zebra.demo.zebralib.rfidreader.settings.PreFilterFragment;
import com.zebra.demo.zebralib.rfidreader.settings.ProfileFragment;
import com.zebra.demo.zebralib.rfidreader.settings.RegulatorySettingsFragment;
import com.zebra.demo.zebralib.rfidreader.settings.SaveConfigurationsFragment;
...
import com.zebra.demo.zebralib.rfidreader.settings.SingulationControlFragment;
import com.zebra.demo.zebralib.rfidreader.settings.StartStopTriggersFragment;
import com.zebra.demo.zebralib.rfidreader.settings.TagReportingFragment;
import com.zebra.demo.zebralib.rfidreader.settings.UsbMiFiFragment;
import com.zebra.demo.zebralib.rfidreader.settings.WifiFragment;
import com.zebra.demo.zebralib.scanner.activities.AssertFragment;
import com.zebra.demo.zebralib.scanner.activities.BaseActivity;
import com.zebra.demo.zebralib.scanner.activities.BatteryStatistics;
import com.zebra.demo.zebralib.scanner.activities.BeeperActionsActivity;
import com.zebra.demo.zebralib.scanner.activities.BeeperActionsFragment;
import com.zebra.demo.zebralib.scanner.activities.ImageActivity;
import com.zebra.demo.zebralib.scanner.activities.IntelligentImageCaptureActivity;
import com.zebra.demo.zebralib.scanner.activities.LEDActivity;
import com.zebra.demo.zebralib.scanner.activities.NavigationHelpActivity;
import com.zebra.demo.zebralib.scanner.activities.SampleBarcodes;
import com.zebra.demo.zebralib.scanner.activities.ScaleActivity;
import com.zebra.demo.zebralib.scanner.activities.ScanSpeedAnalyticsActivity;
import com.zebra.demo.zebralib.scanner.activities.SsaSetSymbologyActivity;
import com.zebra.demo.zebralib.scanner.activities.SymbologiesActivity;
import com.zebra.demo.zebralib.scanner.activities.SymbologiesFragment;
import com.zebra.demo.zebralib.scanner.activities.UpdateFirmware;
import com.zebra.demo.zebralib.scanner.activities.VibrationFeedback;
...
import com.zebra.demo.zebralib.scanner.fragments.BarcodeFargment;
import com.zebra.demo.zebralib.scanner.fragments.ReaderDetailsFragment;
import com.zebra.demo.zebralib.scanner.fragments.SettingsFragment;
import com.zebra.demo.zebralib.scanner.fragments.Static_ipconfig;
import com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter;
import com.zebra.demo.zebralib.scanner.helpers.ActiveDevicePremiumAdapter;
import com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceStandardAdapter;
...
import com.zebra.demo.zebralib.scanner.helpers.DotsProgressBar;
import com.zebra.demo.zebralib.scanner.helpers.ScannerAppEngine;
import com.zebra.demo.zebralib.scanner.receivers.NotificationsReceiver;
import com.zebra.demo.zebralib.wifi.ReaderWifiSettingsFragment;
import com.zebra.demo.zebralib.wifi.WifiPasswordDialog;
...
import static com.zebra.demo.zebralib.application.Application.DEVICE_PREMIUM_PLUS_MODE;
import static com.zebra.demo.zebralib.application.Application.DEVICE_STD_MODE;
import static com.zebra.demo.zebralib.application.Application.RFD_DEVICE_MODE;
import static com.zebra.demo.zebralib.application.Application.TAG_LIST_LOADED;
import static com.zebra.demo.zebralib.application.Application.TAG_LIST_MATCH_MODE;
import static com.zebra.demo.zebralib.application.Application.TOTAL_TAGS;
import static com.zebra.demo.zebralib.application.Application.UNIQUE_TAGS;
import static com.zebra.demo.zebralib.application.Application.UNIQUE_TAGS_CSV;
import static com.zebra.demo.zebralib.application.Application.currentFragment;
import static com.zebra.demo.zebralib.application.Application.inventoryList;
import static com.zebra.demo.zebralib.application.Application.mConnectedDevice;
import static com.zebra.demo.zebralib.application.Application.matchingTags;
import static com.zebra.demo.zebralib.application.Application.matchingTagsList;
import static com.zebra.demo.zebralib.application.Application.memoryBankId;
import static com.zebra.demo.zebralib.application.Application.missedTags;
import static com.zebra.demo.zebralib.application.Application.missingTagsList;
import static com.zebra.demo.zebralib.application.Application.tagListMap;
import static com.zebra.demo.zebralib.application.Application.tagsListCSV;
import static com.zebra.demo.zebralib.application.Application.tagsReadForSearch;
import static com.zebra.demo.zebralib.application.Application.tagsReadInventory;
import static com.zebra.demo.zebralib.application.Application.unknownTagsList;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.EXPORT_DATA;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.clearInventoryData;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.getInstance;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.isInventoryAborted;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.isLocatingTag;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.isLocationingAborted;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.isTriggerRepeat;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.mConnectedReader;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.mInventoryStartPending;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.mIsInventoryRunning;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.mRRStartedTime;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.mReaderDisappeared;
import static com.zebra.demo.zebralib.rfidreader.rfid.RFIDController.tagListMatchNotice;
import static com.zebra.demo.zebralib.scanner.activities.UpdateFirmware.isWaitingForFWUpdateToComplete;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.ANTENNA_SETTINGS_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.APPLICATION_SETTINGS_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.ASSERT_DEVICE_INFO_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.BARCODE_SYMBOLOGIES_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.BARCODE_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.BATTERY_STATISTICS_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.BEEPER_ACTION_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.CHARGE_TERMINAL_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.DEVICE_PAIR_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.DEVICE_RESET_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.DPO_SETTING_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.FACTORY_RESET_FRAGMENT_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.INVENTORY_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.KEYREMAP_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.LOCATE_TAG_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.LOGGER_FRAGMENT_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.MAIN_GENERAL_SETTINGS_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.MAIN_HOME_SETTINGS_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.MAIN_RFID_SETTINGS_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.NONOPER_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.RAPID_READ_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.READERS_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.READER_DETAILS_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.READER_LIST_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.READER_WIFI_SETTINGS_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.RFID_ACCESS_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.RFID_ADVANCED_OPTIONS_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.RFID_BEEPER_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.RFID_LED_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.RFID_PREFILTERS_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.RFID_PROFILES_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.RFID_REGULATORY_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.RFID_SETTINGS_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.RFID_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.RFID_WIFI_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.SAVE_CONFIG_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.SCAN_ADVANCED_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.SCAN_DATAVIEW_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.SCAN_HOME_SETTINGS_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.SCAN_SETTINGS_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.SCAN_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.SETTINGS_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.SINGULATION_CONTROL_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.START_STOP_TRIGGER_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.STATIC_IP_CONFIG;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.TAG_REPORTING_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.UPDATE_FIRMWARE_TAB;
import static com.zebra.demo.zebralib.scanner.helpers.ActiveDeviceAdapter.USB_MIFI_TAB;
...
public class ActiveDeviceActivity extends BaseActivity implements AdvancedOptionItemFragment.OnAdvancedListFragmentInteractionListener, ActionBar.TabListener, ScannerAppEngine.IScannerAppEngineDevEventsDelegate, ScannerAppEngine.IScannerAppEngineDevConnectionsDelegate,
        ISettingsUtil,  RFIDBaseActivity.CreateFileInterface { //NavigationView.OnNavigationItemSelectedListener
    ...
    //RapidReadFragment rapidReadFragment;
...
//        switchToFragment(new AssetViewFragment());
        setTriggerMode(ENUM_TRIGGER_MODE.RFID_MODE);
        selectedFragment = new MainMenuFragment(); //RapidReadFragment();
    ...
    public void switchToFragmentAddBackStack(Fragment fragment) {
        if (fragment != null) {
            getSupportFragmentManager().beginTransaction().replace(R.id.settings_content_frame, fragment, TAG_CONTENT_FRAGMENT).addToBackStack(null).commit();
            selectedFragment = fragment;
        }
    }
    ...
    private void checkExitApp() {
        try {
            ...
            if (fragments < 1) {
                ...
                android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(ActiveDeviceActivity.this)
...
*/
    ...
    protected void onResume() {
       ...
       if(RFIDController.regionNotSet == true ) {
        ...
        detailsIntent.putExtra(com.zebra.demo.zebralib.rfidreader.common.Constants.SETTING_ITEM_ID, R.id.regulatory);
        detailsIntent.putExtra(com.zebra.demo.zebralib.rfidreader.common.Constants.SETTING_ON_FACTORY, true);
...
//    }
    ...
    public synchronized void scannerBarcodeEvent(byte[] barcodeData, int barcodeType, int scannerID) {
        ...
        Log.d(TAG, "Sat-" +  new String(barcodeData));
        Log.d(TAG, "Sat-" + BarcodeTypes.getBarcodeTypeName(barcodeType));

        if (selectedFragment != null) {
        ((BarcodeRFIDScanBaseFragment) selectedFragment).scannerBarcodeEventDetected(barcodeData, barcodeType, scannerID);
        }
...
//                detailsIntent.putExtra(com.zebra.demo.zebralib.rfidreader.common.Constants.SETTING_ITEM_ID, R.id.battery);
...
/*    public int getCurrentTabPosition() {
        ...
        new Handler().postDelayed(new Runnable() {
            public void run() {
                if (d != null && d.isShowing()) {
                    sendNotification(com.zebra.demo.zebralib.rfidreader.common.Constants.ACTION_READER_STATUS_OBTAINED, command + " timeout");
                    d.dismiss();
    ...
    public void saveConfigClicked(View v) {
        if (mConnectedReader != null && mConnectedReader.isConnected()) {
            progressDialog = new com.zebra.demo.zebralib.rfidreader.common.CustomProgressDialog(this, getString(R.string.save_config_progress_title));
            progressDialog.show();
            timerDelayRemoveDialog(com.zebra.demo.zebralib.rfidreader.common.Constants.SAVE_CONFIG_RESPONSE_TIMEOUT, progressDialog, getString(R.string.status_failure_message), false);
