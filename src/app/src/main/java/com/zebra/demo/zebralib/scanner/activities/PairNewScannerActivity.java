...
public class PairNewScannerActivity extends BaseActivity
...
/*        int id = item.getItemId();
    ...
    protected void onResume() {
        ...
        if(dialogBTAddress == null && firstRun && !dntShowMessage){
            dialog = new Dialog(PairNewScannerActivity.this);
    ...
    private void generatePairingBarcode() {
        ...
        btAddress = settings.getString(Constants.PREF_BT_ADDRESS, "");
        if(btAddress.equals("")) {
            llBarcode.removeAllViews();
        } else {
            BarCodeView barCodeView = Application.sdkHandler.dcssdkGetPairingBarcode(selectedProtocol, selectedConfig, btAddress);
            if (barCodeView != null) {
    ...
    /*private String getDeviceBTAddress(SharedPreferences settings) {
        ...
        if (bluetoothMAC.equals("")) {
            if (dialogBTAddress == null) {
                dialogBTAddress = new Dialog(PairNewScannerActivity.this);
                ...
                skipButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intent = new Intent(PairNewScannerActivity.this, ScannersActivity.class);
                        startActivity(intent);
                    }
                });
    ...
    private void startHomeActivityAgain() {
        Intent i = new Intent(this, PairNewScannerActivity.class);
...
/*    @Override
    ...
    public boolean scannerHasConnected(int scannerID) {
        ...
        Intent intent = new Intent(PairNewScannerActivity.this, ActiveScannerActivity.class);
